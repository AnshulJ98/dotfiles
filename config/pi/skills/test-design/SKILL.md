---
name: test-design
description: Testing strategies and patterns — Dodds testing trophy, unit vs integration vs E2E, AAA, mocking at boundaries (MSW, DI), fixtures/factories, async testing, snapshot strategy, coverage targets. Load when designing a test suite, deciding what/how to test, debugging flaky tests, or reviewing test quality.
---
