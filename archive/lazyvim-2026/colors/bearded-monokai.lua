...
hi("SnacksPickerDirectory", { fg = c.cyan })
hi("SnacksPickerFile", { fg = c.fg })
hi("SnacksPickerMatch", { fg = c.yellow, bold = true })
hi("SnacksPickerSelected", { fg = c.yellow })
hi("SnacksPickerDimmed", { fg = c.fg_dim })
hi("SnacksPickerTotals", { fg = c.fg_dim })

-- Path states (filename color when file is hidden/ignored)
hi("SnacksPickerPathIgnored", { fg = c.fg_muted, italic = true })
hi("SnacksPickerPathHidden", { fg = c.fg_dim })

-- Git status (icons AND filenames, because formatters.file.git_status_hl=true
-- makes the explorer rewrite the filename highlight to one of these groups)
hi("SnacksPickerGitStatus", { fg = c.fg })
hi("SnacksPickerGitStatusUntracked", { fg = c.green })
hi("SnacksPickerGitStatusAdded", { fg = c.green })
hi("SnacksPickerGitStatusModified", { fg = c.yellow })
hi("SnacksPickerGitStatusDeleted", { fg = c.red })
hi("SnacksPickerGitStatusRenamed", { fg = c.cyan })
hi("SnacksPickerGitStatusCopied", { fg = c.cyan })
hi("SnacksPickerGitStatusStaged", { fg = c.orange })
hi("SnacksPickerGitStatusUnmerged", { fg = c.bright_red, bold = true })
hi("SnacksPickerGitStatusIgnored", { fg = c.fg_muted, italic = true })

-- ---------------------------------------------------------------------------
-- Markdown rendering (render-markdown.nvim)
-- ---------------------------------------------------------------------------
-- Heading H1-H6: bg is darkened version of the heading's fg color.
-- These are the single source of truth (no plugin-side overrides).
hi("RenderMarkdownH1", { fg = c.yellow, bold = true })
hi("RenderMarkdownH1Bg", { bg = "#2a2200", fg = c.yellow, bold = true })
hi("RenderMarkdownH2", { fg = c.purple, bold = true })
hi("RenderMarkdownH2Bg", { bg = "#1a0033", fg = c.purple, bold = true })
hi("RenderMarkdownH3", { fg = c.cyan, bold = true })
hi("RenderMarkdownH3Bg", { bg = "#0d2a33", fg = c.cyan, bold = true })
hi("RenderMarkdownH4", { fg = c.green, bold = true })
hi("RenderMarkdownH4Bg", { bg = "#0d331a", fg = c.green, bold = true })
hi("RenderMarkdownH5", { fg = c.pink, bold = true })
hi("RenderMarkdownH5Bg", { bg = "#330d1a", fg = c.pink, bold = true })
hi("RenderMarkdownH6", { fg = c.orange, bold = true })
hi("RenderMarkdownH6Bg", { bg = "#33200d", fg = c.orange, bold = true })
